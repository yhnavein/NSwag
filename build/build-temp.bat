...
xcopy "../src/NSwag.Console/bin/Release/net461" "../src/NSwag.Npm/bin/binaries/Win" /E /I /y
xcopy "..\src\NSwag.Console.x86\bin\Release\net461\NSwag.x86.exe" "..\src\NSwag.Npm\bin\binaries\Win"
xcopy "..\src\NSwag.Console.x86\bin\Release\net461\NSwag.x86.exe.config" "..\src\NSwag.Npm\bin\binaries\Win"
...
xcopy "../src/NSwag.ConsoleCore/bin/release/netcoreapp1.0/publish" "../src/NSwag.Npm/bin/binaries/NetCore10" /E /I /y
xcopy "../src/NSwag.ConsoleCore/bin/release/netcoreapp1.1/publish" "../src/NSwag.Npm/bin/binaries/NetCore11" /E /I /y
xcopy "../src/NSwag.ConsoleCore/bin/release/netcoreapp2.0/publish" "../src/NSwag.Npm/bin/binaries/NetCore20" /E /I /y
